...
export type Global = {
  ...
  soMarkFromDaeSet: Scalars['Boolean']['output']
...
export type GlobalInput = {
  ...
  autoSniffPunt?: InputMaybe<Scalars['Boolean']['input']>
  ...
  bpfConnStateMapSize?: InputMaybe<Scalars['Int']['input']>
  ...
  disableThp?: InputMaybe<Scalars['Boolean']['input']>
  ...
  soMarkFromDaeSet?: InputMaybe<Scalars['Boolean']['input']>
